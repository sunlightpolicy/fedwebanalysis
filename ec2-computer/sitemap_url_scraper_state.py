...
#def main():
    ...
    endings = ["page-sitemap1.xml","page-sitemap2.xml","page-sitemap3.xml","page-sitemap4.xml",
               "page-sitemap5.xml","page-sitemap6.xml","page-sitemap7.xml","page-sitemap8.xml",
               "page-sitemap9.xml","page-sitemap10.xml","page-sitemap11.xml","page-sitemap12.xml",
               "page-sitemap13.xml","state_state-sitemap.xml","state_biography-sitemap.xml",
               "state_briefing-sitemap.xml","state_bureau-sitemap.xml","state_country-sitemap.xml",
               "state_report-sitemap1.xml","state_report-sitemap2.xml","state_report-sitemap3.xml",
               "state_trip_travel-sitemap.xml","state_briefing_type-sitemap.xml","state_bureaus-sitemap.xml",
               "state_countries_and_areas-sitemap.xml","state_document_type-sitemap.xml",
               "state_policy_issues-sitemap.xml", "state_report_types-sitemap.xml","state_states-sitemap.xml",
               "state_subjects-sitemap.xml","state_years-sitemap.xml","state_author_groups-sitemap.xml",
               "author-sitemap.xml"]
