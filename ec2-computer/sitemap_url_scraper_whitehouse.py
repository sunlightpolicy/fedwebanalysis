...
#def main():
    ...
    endings = ["post-sitemap.xml","page-sitemap.xml","briefing-statement-sitemap1.xml",
               "briefing-statement-sitemap2.xml","briefing-statement-sitemap3.xml",
               "briefing-statement-sitemap4.xml","briefing-statement-sitemap5.xml",
               "presidential-action-sitemap1.xml","presidential-action-sitemap2.xml",
               "eop-component-sitemap.xml","microsite-sitemap.xml","authors-sitemap.xml",
               "issue-sitemap.xml"]
