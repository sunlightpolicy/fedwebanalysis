...
# run file: python sitemap_url_scraper_ice.py "[2016,1,1,2017,1,19]" "https://www.ice.gov" "ice_urls.csv" "ice_403_postpose.csv" "ice_all_urls.csv"
...
#def main():
    ...
    #dates = [2016,1,1,2017,1,19]
    #domain = "https://www.nih.gov/"
    #output_file = 'hhs_urls.csv'

    headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36 Edge/12.246'}

    # acquire sitemap information
    r = requests.get(domain + "/sitemap.xml", headers=headers) 
    xml_text = r.text
